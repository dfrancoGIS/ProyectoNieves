...
export class RecursosService {
  ...
  editarRecurso(id_recurso: string, datos: any): Observable<any> {
    ...
    // Nuevo método para obtener recursos filtrados por empresa
    getRecursosPorEmpresa(empresaRecurso: string): Observable<any> {
      const params = new HttpParams().set('empresaRecurso', empresaRecurso);
      return this.http.get<any>(`${this.baseUrl}/recursos-por-empresa`, { params });
    }
}
